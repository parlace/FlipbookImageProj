 ...
 */
UCLASS()
class FLIPBOOKIMAGEPROJ_API UUIFlipbook : public UWidget
{
	GENERATED_BODY()
...
public:
	...
	/** Range is 0.01 ~ 100 (0.01s is 100FPS, 100s is 0.01FPS)*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UIFlipbook", meta = (ClampMin = "0.01", ClampMax = "100"))
	float Duration;
